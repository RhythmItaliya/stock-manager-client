...
export const columns: ColumnDef<WatchMarket>[] = [
  {
    ...
    header: ({ column }) => (
      <DataTableColumnHeader
        column={column}
        title={columnTitleMapping['displayName']}
      />
    ),
    cell: ({ row }) => (
...

  {
    header: ({ column }) => (
      <DataTableColumnHeader
        column={column}
        title={columnTitleMapping['ltpc.cp-t']}
      />
    ),
...

  {
    header: ({ column }) => (
      <DataTableColumnHeader
        column={column}
        title={columnTitleMapping['ltpc.ltp']}
      />
    ),
...

  {
    header: ({ column }) => (
      <DataTableColumnHeader
        column={column}
        title={columnTitleMapping['marketLevel.bidAskQuote.bp']}
      />
    ),
...

  {
    header: ({ column }) => (
      <DataTableColumnHeader
        column={column}
        title={columnTitleMapping['marketLevel.bidAskQuote.ap']}
      />
    ),
...

  {
    header: ({ column }) => (
      <DataTableColumnHeader
        column={column}
        title={columnTitleMapping['marketOHLC.ohlc.open']}
      />
    ),
...

  {
    header: ({ column }) => (
      <DataTableColumnHeader
        column={column}
        title={columnTitleMapping['marketOHLC.ohlc.high']}
      />
    ),
...

  {
    header: ({ column }) => (
      <DataTableColumnHeader
        column={column}
        title={columnTitleMapping['marketOHLC.ohlc.low']}
      />
    ),
...

  {
    header: ({ column }) => (
      <DataTableColumnHeader
        column={column}
        title={columnTitleMapping['ltpc.cp']}
      />
    ),
    accessorFn: (row) => row.ltpc?.cp,
    id: 'ltpc.cp',
...

  {
    header: ({ column }) => (
      <DataTableColumnHeader
        column={column}
        title={columnTitleMapping['marketLevel.bidAskQuote']}
      />
    ),
...

  {
    header: ({ column }) => (
      <DataTableColumnHeader
        column={column}
        title={columnTitleMapping['marketOHLC.ohlc']}
      />
    ),
    ...
    cell: ({ row }) => {
      ...
      const headers = [
        {
          key: 'interval',
          title: columnTitleMapping['marketOHLC.ohlc.interval'],
        },
...

  {
    header: ({ column }) => (
      <DataTableColumnHeader
        column={column}
        title={columnTitleMapping['optionGreeks']}
      />
    ),
...

  {
    header: ({ column }) => (
      <DataTableColumnHeader
        column={column}
        title={columnTitleMapping['ltpc.date']}
      />
    ),
...

  {
    header: ({ column }) => (
      <DataTableColumnHeader
        column={column}
        title={columnTitleMapping['ltpc.time']}
      />
    ),
    accessorFn: (row) => row.ltpc?.ltt,
    id: 'ltpc.time',
