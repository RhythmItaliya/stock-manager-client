...
const AuthenticatedWatchMarketIndexLazyImport = createFileRoute(
...
const AuthenticatedWatchMarketIndexLazyRoute =
  AuthenticatedWatchMarketIndexLazyImport.update({
    id: '/watch-market/',
    path: '/watch-market/',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any).lazy(() =>
    import('./routes/_authenticated/watch-market/index.lazy').then(
      (d) => d.Route,
    ),
  )
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/watch-market/': {
      id: '/_authenticated/watch-market/'
      path: '/watch-market'
      fullPath: '/watch-market'
      preLoaderRoute: typeof AuthenticatedWatchMarketIndexLazyImport
      parentRoute: typeof AuthenticatedRouteImport
    }
  }
}
...
interface AuthenticatedRouteRouteChildren {
  ...
  AuthenticatedWatchMarketIndexLazyRoute: typeof AuthenticatedWatchMarketIndexLazyRoute
}
...
const AuthenticatedRouteRouteChildren: AuthenticatedRouteRouteChildren = {
  ...
  AuthenticatedWatchMarketIndexLazyRoute:
    AuthenticatedWatchMarketIndexLazyRoute,
}
...
export interface FileRoutesByFullPath {
  ...
  '/watch-market': typeof AuthenticatedWatchMarketIndexLazyRoute
}
...
export interface FileRoutesById {
  ...
  '/_authenticated/watch-market/': typeof AuthenticatedWatchMarketIndexLazyRoute
}
...
/* ROUTE_MANIFEST_START
{
  "routes": {
    ...
    "/_authenticated/watch-market/": {
      "filePath": "_authenticated/watch-market/index.lazy.tsx",
      "parent": "/_authenticated"
    }
  }
}
